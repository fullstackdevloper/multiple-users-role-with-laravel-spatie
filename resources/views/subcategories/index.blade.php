<x-app-layout>
    ...
    <div class="flex-1 max-h-full p-5 overflow-hidden" x-data="{}">
        <h3 class="mt-6 text-xl">Sub Categories</h3>
        <div class="flex justify-end">
            <a href="{{ route('subcategory.create') }}" class="your-button-styles">
                <x-primary-button>{{ __('Add SubCategory') }}</x-primary-button>
            </a>
        </div>
                                ...
                                @forelse ($categories as $category)
                                    <tr class="transition-all hover:bg-gray-100 hover:shadow-lg">
                                        ...
                                        <td class="px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                            ...
                                            <a href="{{ route('subcategory.edit', ['subcategory' => $category]) }}"
